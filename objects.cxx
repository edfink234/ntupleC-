...
PhysicsObject::PhysicsObject(TChain* entry, int index, int entry_number, const char* name, const char* title)
...
TruthParticle::TruthParticle(TChain* entry, int index, int entry_number, const char* name, const char* title)
:   PhysicsObject::PhysicsObject(entry, index, entry_number, name, title),
    Cluster_eta{0.0}
{
...
int TruthParticle::barcode()
{
    ...
    _entry.GetBranch("mc_barcode")->GetEntry(_entry_number);
...
int TruthParticle::parent_barcode()
{
    ...
    _entry.GetBranch("mc_parent_barcode")->GetEntry(_entry_number);
...
int TruthParticle::status_code()
{
    ...
    _entry.GetBranch("mc_status")->GetEntry(_entry_number);
...
double TruthParticle::charge()
{
    ...
    _entry.GetBranch("mc_charge")->GetEntry(_entry_number);
...
double TruthParticle::phi()
{
    ...
    _entry.GetBranch("mc_phi")->GetEntry(_entry_number);
...
double TruthParticle::e()
{
    ...
    _entry.GetBranch("mc_e")->GetEntry(_entry_number);
...
double TruthParticle::m()
{
    ...
    _entry.GetBranch("mc_mass")->GetEntry(_entry_number);
...
Electron::Electron(TChain* entry, int index, double pt, double energy, int entry_number, const char* name, const char* title)
: TruthParticle::TruthParticle(entry, index, entry_number, name, title),
  _systematic_pt{pt},
...
double Electron::pt()
{
    ...
    _entry.GetBranch("electron_pt")->GetEntry(_entry_number);
...
double Electron::e()
{
    ...
    _entry.GetBranch("electron_e")->GetEntry(_entry_number);
...
double Electron::phi()
{
    ...
    _entry.GetBranch("electron_phi")->GetEntry(_entry_number);
...
int Electron::id_()
{
    ...
    _entry.GetBranch("electron_id")->GetEntry(_entry_number);
...
double Electron::isolation()
{
    ...
    _entry.GetBranch("electron_isolation")->GetEntry(_entry_number);
...
double Electron::d0()
{
    ...
    _entry.GetBranch("electron_d0")->GetEntry(_entry_number);
...
double Electron::z0()
{
    ...
    _entry.GetBranch("electron_z0")->GetEntry(_entry_number);
...
Photon::Photon(TChain* entry, int index, double pt, double energy, int entry_number, const char* name, const char* title)
: TruthParticle::TruthParticle(entry, index, entry_number, name, title),
  _systematic_pt{pt},
  _systematic_energy{energy}
{
...
double Photon::pt()
{
    ...
    _entry.GetBranch("photon_pt")->GetEntry(_entry_number);
...
double Photon::e()
{
    ...
    _entry.GetBranch("photon_e")->GetEntry(_entry_number);
...
double Photon::eta()
{
    ...
    _entry.GetBranch("photon_eta")->GetEntry(_entry_number);
...
double Photon::phi()
{
    ...
    _entry.GetBranch("photon_phi")->GetEntry(_entry_number);
...
double Photon::isolation()
{
    ...
    _entry.GetBranch("photon_etcone40")->GetEntry(_entry_number);
...
int Photon::id_()
{
    ...
    _entry.GetBranch("photon_id")->GetEntry(_entry_number);
...
int Photon::id_loose()
{
    ...
    _entry.GetBranch("photon_id_loose")->GetEntry(_entry_number);
...
int Photon::id_tight()
{
    ...
    _entry.GetBranch("photon_id_tight")->GetEntry(_entry_number);
...
double Photon::cluster_eta()
{
    ...
    _entry.GetBranch("photon_cluster_eta_be_2")->GetEntry(_entry_number);
...
int Photon::id_nn()
{
    ...
    _entry.GetBranch("photon_id_nn")->GetEntry(_entry_number);
...
Cluster::Cluster(TChain* entry, int index, int entry_number, const char* name, const char* title)
:   PhysicsObject::PhysicsObject(entry, index, entry_number,  name, title)
{
...
double Cluster::pt()
{
    ...
    _entry.GetBranch("cluster_pt")->GetEntry(_entry_number);
...
double Cluster::eta()
{
    ...
    _entry.GetBranch("cluster_eta")->GetEntry(_entry_number);
...
double Cluster::phi()
{
    ...
    _entry.GetBranch("cluster_phi")->GetEntry(_entry_number);
...
double Cluster::e()
{
    ...
    _entry.GetBranch("cluster_e")->GetEntry(_entry_number);
...
Track::Track(TChain* entry, int index, int entry_number, const char* name, const char* title)
:   PhysicsObject::PhysicsObject(entry, index, entry_number, name, title)
{
...
double Track::pt()
{
    ...
    _entry.GetBranch("track_pt")->GetEntry(_entry_number);
...
double Track::charge()
{
    ...
    _entry.GetBranch("track_charge")->GetEntry(_entry_number);
...
double Track::eta()
{
    ...
    _entry.GetBranch("track_eta")->GetEntry(_entry_number);
...
double Track::phi()
{
    ...
    _entry.GetBranch("track_phi")->GetEntry(_entry_number);
...
double Track::e()
{
    ...
    _entry.GetBranch("track_e")->GetEntry(_entry_number);
...
int Track::num_pixel_hits()
{
    ...
    _entry.GetBranch("track_num_pixel_hits")->GetEntry(_entry_number);
...
int Track::num_sct_hits()
{
    ...
    _entry.GetBranch("track_num_sct_hits")->GetEntry(_entry_number);
